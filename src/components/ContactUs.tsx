    ...
    <div className="bg-white px-4 py-12" id="contact">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-black max-w-3xl mx-auto text-md">
        ...
        <div className="grid md:grid-cols-2 gap-0 items-start">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <a href="tel:+919773353561" className="text-black hover:underline">
                  +91 9773353561
                </a>
                <br />
                <a href="tel:+919829105960" className="text-black hover:underline">
                  +91 9829105960
                </a>
              </div>
            </div>
          ...
          {/* Contact Form */}
          <Card className="bg-[#ffffff] m-4">
            <CardHeader>
              <CardTitle className="text-2xl text-black">Send Message</CardTitle>
            </CardHeader>
            <CardContent>
              <form className="space-y-4" onSubmit={handleSubmit}>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="border-0 border-b border-zinc-200 rounded-none px-0 py-2 focus-visible:ring-0 focus-visible:border-white text-black"
                  />
                </div>
                <div className="space-y-2">
