        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h1 className="text-lg sm:text-2xl text-white">Get <span className="text-[#ff0000]">Certified</span> & Recognised</h1>
              <p className="text-sm pt-2 sm:text-lg text-white">
            ...
            <div className="grid gap-8">
              ...
              <div className="flex gap-4">
                ...
                <div className="space-y-2">
                  <h3 className=" text-md font-semibold  text-white">Official and verified:</h3>
                  
                  <p className="text-sm sm:text-base leading-normal sm:leading-relaxed text-white">
              ...
              <div className="flex gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm sm:text-base leading-normal text-white sm:leading-relaxed ">
