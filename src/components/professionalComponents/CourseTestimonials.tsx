  ...
  return (
    <div className="bg-[#181A1B] p-4 sm:p-6 mx-auto">
      <div className="max-w-[920px] mx-auto">
        <h2 className="text-white text-lg sm:text-2xl">HEAR IT FROM THEM</h2>
        <h2 className="text-white text-sm  sm:text-lg mb-6 sm:mb-10 mt-2">
        ...
        <div className="flex justify-center items-center mt-6">
          <button
            ...
            className="bg-pink-100 text-black font-semibold text-md border-2 border-white py-3 px-8 rounded-full hover:bg-[#ff0000] hover:text-white transition-all duration-300"
          >
