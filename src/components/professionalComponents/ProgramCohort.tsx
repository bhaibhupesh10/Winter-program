          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <h3 className="text-sm sm:text-lg text-white ">
                LW 7 Days Bootcamp Training Program 2024
              </h3>
              ...
              {[
                ...
                >
                  ...
                  <div className="flex flex-col sm:hidden">
                    ...
                    <div className="font-medium text-sm text-white">Mode</div>
                    <div className="text-white text-sm mb-2">Online/Offline</div>
                  </div>
                  ...
                  <div className="hidden sm:block text-white text-sm">Online/Offline</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card className="p-6 bg-[#181A1B]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {[
                "Get 7 Days Bootcamp Training Certificate from LW Informatics Pvt Ltd",
