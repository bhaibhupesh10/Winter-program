...
const WhatsAppBot = () => {
  ...
  return (
    <div className="fixed bottom-16 right-5 z-50 sm:bottom-5 sm:right-10">
      ...
      {isOpen && (
        <div className="bg-white w-72 sm:w-80 md:w-72 rounded-lg shadow-lg p-4 border border-gray-300 absolute bottom-16 right-0 sm:bottom-20 sm:right-10 md:bottom-28 md:right-0">
